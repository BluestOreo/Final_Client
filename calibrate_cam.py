...
while(count < 100): # capture 100 chessboard frames
    ...
    if retval == True:
        print(f"Frame {count+1}: Chessboard corners found.")  # Add this to verify detection
        corners_new = cv2.cornerSubPix(gray, corners, (11,11), (-1,-1), criteria)
        ...
        print(f"Frame {count+1}: Chessboard corners not found.")  # Add this to track failures
    count += 1
