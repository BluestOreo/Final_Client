...
class ClientWindow:
    def __init__(self, root):
        ...
        self.gaze_tracker = BlinkTracker()
        ...
        self.command_tracker_temp = None 
    ...
    def connect_btn(self):
        ...
        try: 
            ...
            self.eyetracking = Thread(target=self.gaze_tracker.perform_eye_tracking)
    ...
    def vid_stream_btn(self):
        ...
        try:
            ...
            print('Actuator update method error:', e)
    ...
    def update_motor(self):
        print("Received:", self.gaze_tracker.blink_POS)
        
        command_flag = self.gaze_tracker.blink_POS  # Get the updated flag
        ...
        if self.gaze_tracker.blink_POS is not None:
            command_flag = self.gaze_tracker.blink_POS  # Get the updated flag
        #if command_flag is not None:  # Check if the flag is updated
            if command_flag == 0:  # Move forward
            ...
            elif command_flag == 1:  # Move right
            ...
            self.gaze_tracker.blink_POS = None
        elif command_flag == 5:  # Stop:
            # only stop after a double blink
            try:
                self.TCP.sendData(self.Motor_STOP)
                print("Ensuring Stop")
            except:
        ...
        #track commands to implement double blink
        self.command_tracker=command_flag
        # Reset flag variable
        command_flag = None
